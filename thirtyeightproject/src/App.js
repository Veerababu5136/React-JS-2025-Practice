...
function App() {
  return (
    <div className="App">
      ...
      <Link to="/user/87/Supraja">User-1</Link>  &nbsp; &nbsp;
      <Link to="/user/A6/chinni">User-2</Link>  &nbsp; &nbsp;
      <Link to="/user/77/Amrutha">User-3</Link>  &nbsp; &nbsp;
      <Link to="/user/88">User-4</Link> &nbsp; &nbsp;
          <Link to="/user/pavani/98">User-5</Link> &nbsp; &nbsp;



      <Routes>

        <Route path="/user/:id/:name" element={<User/>}>User-1</Route>
